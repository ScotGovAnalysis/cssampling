...
shes.sframe <- css_used_addresses(prev_samples = usedaddresses,
                              paf = clean_paf)
nrow(shes.sframe)
...
shes.frameandmatchedsample <- shes.sframe %>% 
  css_merge_frame_sample(shes.totalsample)
...
css_export_rds(shes.totalsample)

css_export_rds(shes.samplesize)

css_export_rds(shes.frameandmatchedsample)

css_export_rds(shes.biomod.frameandmatchedsample)
