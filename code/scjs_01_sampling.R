#########################################################################
# Name of file - 01_scjs_sampling.R
#
...
scjs.initial.samplesize <- read.csv(scjs.samplesize.path, 
                                    header = TRUE, na = "") %>%
  clean_names_modified()
...
scjs.sframe <- scjs.sframe[order(scjs.sframe$la_code,
                             scjs.sframe$dz11_urbrur2020,
                             scjs.sframe$simd20rank,
                             scjs.sframe$postcode,
                             scjs.sframe$print_address),]
...
scjs.frameandmatchedsample <- scjs.sframe %>%
  left_join(scjs.initial.totalsample) %>%
